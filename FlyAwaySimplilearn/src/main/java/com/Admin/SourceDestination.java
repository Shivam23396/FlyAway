...
public class SourceDestination extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
				...
				PreparedStatement stmt = conn.prepareStatement("select source,destination from airline");
				...
				out.println("<center><input type=\"submit\" value=\"GO BACK TO ADMIN PORTAL\"></center>");
				out.print("</form>");
				out.print("</body></html>");
